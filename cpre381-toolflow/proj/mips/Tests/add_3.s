...
# the tests below are used as a set up 
# same as test 2 showing the powers of 2 stored in the registers
# this is being used to set up for the actual test below
...
# at this point the max value has been reached (2^(32) = 4.29e9) 
# the tests below are focusing on what happens in the case of going past the limit of the ALU
    add $31, $31, $31     # $31 = 4.29e9 * 2 --> should be 8.58e9 
    add $31, $31, $31     # $31 = 8.58e9 * 2 --> should be 1.72e10
    add $31, $31, $31     # $31 = 1.72e10 * 2 --> should be 3.43e10  
    # End Test
